...
import logoLight from 'assets/logoblanco.png';
    ...
    <Box as="footer" sx={styles.footer}>
      <Container sx={styles.container}>
        ...
        >
          ...
          >
            Derechos Reservados por {new Date().getFullYear()} DevPom, Inc
          </Text>
        </Box>
        <Box sx={styles.linksWrap}>
          <Link path="/">Home</Link>
          <Link path="/">Refacciones</Link>
          <Link path="/">Servicios</Link>
          <Link path="/">Preguntas Frecuentes</Link>
        </Box>
      </Container>
    </Box>
  );
